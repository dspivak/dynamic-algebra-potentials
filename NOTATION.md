...
| Closed phase step | (unnamed; `eqn.closed_update`) | self-map of `\absval{T^*Q}` for a closed scalar `f`: `(q,\xi)\mapsto(q+\sharpR_q\xi,\,\xi-dU|_{\tilde q})`; the wave/graph-Laplacian setting |
