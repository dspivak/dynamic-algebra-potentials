...
To each $(\vec v,\vec \omega)$, the vector of outputs of the internal boxes, we assign the external output $(v_K,\omega_1)$, and to each external input $(\omega_K,v_0)$; in our concise format,
\[
(\vec v,\vec \omega)\mapsto\Big((v_K,\omega_1),\;(\omega_K,v_0)\mapsto\bigl((0,v_0),\,(0,v_1),\,\ldots,\,(0,v_{K-2}),\,(\omega_K,v_{K-1})\bigr)\Big).
\]
